"""
@description: Validate and package a set of prediction files for submission to the leaderboard.
@reference: copy from "av2-api\src\av2\evaluation\scene_flow\make_submission_archive.py"
