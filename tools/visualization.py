...
def check_flow(
        data_dir: str = "/data/jiehao/dataset/deflow/demo_data/av2/preprocess_v2/sensor/vis",
    ...
    o3d_vis = MyVisualizer(view_file=VIEW_FILE,
                           window_title=f"view {'ground truth flow' if res_name == 'flow' else f'{res_name} flow'}, `SPACE` start/stop")
